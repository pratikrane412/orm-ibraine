...
import "../styles/FortunerProductsPage.css"; 
...
const categories = [
  ...
  { name: "Toyota Fortuner", count: 20, active: true, path: "/products/fortuner" },//Active
    ...
    <div className="page-wrapper">
      ...
      <div className="main-layout">
        ...
        <main className="product-content">
          ...
          {loading ? (
            <div className="loading">Loading Fortuner Products...</div>
          ) : (
...
export default FortunerProductsPage;
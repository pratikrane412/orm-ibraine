...
import "../styles/JimnyProductsPage.css"; 
...
const categories = [
  ...
  { name: "Suzuki Jimny", count: 20, active: true, path: "/products/jimny" },//Active
  { name: "Range Rover Defender", count: 20, active: false, path: "/products/defender" },
];

const JimnyProductsPage = () => {
    ...
    <div className="page-wrapper">
      ...
      <div className="main-layout">
        ...
        <main className="product-content">
          ...
          {loading ? (
            <div className="loading">Loading Jimny Products...</div>
          ) : (
...
export default JimnyProductsPage;